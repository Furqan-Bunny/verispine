    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="bg-white rounded-xl shadow-lg p-6 sm:p-10">
        ...
        <div className="prose prose-gray max-w-none space-y-8 text-gray-700 leading-relaxed">
          <p>
            These Terms and Conditions ("Terms") govern the use of the Quicksell online
            marketplace (auction and fixed-price), website, mobile application, and related
            services (collectively, the "Platform").
          </p>
          <p>
            By accessing, registering on, bidding on, selling through, or otherwise using Quicksell,
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>"Quicksell"</strong> means Quicksell (Pty) Ltd or its nominated operating entity.</li>
              ...
              <li><strong>"Item"</strong> means any goods or services listed on Quicksell.</li>
              <li><strong>"Wallet"</strong> means the digital balance held in a User's Quicksell account, denominated in South African Rand (ZAR).</li>
          ...
          <section>
            ...
            <p className="mt-2">KYC submissions are reviewed manually by Quicksell administrators within 1-2 business days. Quicksell reserves the right to require KYC verification at any time.</p>

            <p className="font-semibold text-gray-800 mt-4 mb-3">3.4 Account Accuracy</p>
            <p>Users must provide accurate, current, and complete registration information. Quicksell reserves the right to suspend or terminate accounts providing false or misleading information.</p>

            <p className="font-semibold text-gray-800 mt-4 mb-3">3.5 Account Security</p>
            <p>Users are responsible for maintaining the confidentiality of their login credentials. Passwords are securely hashed and cannot be recovered by Quicksell. If you suspect unauthorised access to your account, you must notify Quicksell immediately and reset your password.</p>
          </section>

          {/* 4. PLATFORM ROLE */}
          <section>
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">4. Platform Role and Limitation</h2>
            <p>4.1 Quicksell is an online marketplace and, in certain circumstances, may also act as a Seller or Buyer, unless explicitly stated otherwise.</p>
            <p>4.2 Quicksell does not guarantee the quality, legality, safety, or accuracy of items listed by third-party Sellers.</p>
          ...
          <section>
            ...
            <p>5.5 Quicksell may withdraw or cancel items after bidding has commenced under exceptional circumstances, including but not limited to suspected fraud, prohibited items, or technical errors.</p>
          </section>
          ...
          <section>
            ...
            <p>Quicksell may charge the following fees:</p>
            <ul className="list-disc pl-6 space-y-1 mt-2">
            ...
            <p>Quicksell supports the following payment methods, all denominated in South African Rand (ZAR):</p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 my-4">
              <div className="bg-gray-50 rounded-lg p-4">
                <p className="font-semibold text-gray-900 mb-2">Quicksell Wallet</p>
            ...
            <p className="font-semibold text-gray-800 mt-4 mb-3">6.4 Quicksell Wallet</p>
            <ul className="list-disc pl-6 space-y-2 mt-2">
            ...
            <p>If a payment fails or is cancelled, the order will remain in "Pending Payment" status. The Buyer may retry payment using the same or a different payment method. If payment is not completed within a reasonable period, Quicksell reserves the right to cancel the order and relist the item.</p>
          </section>
          ...
          <section>
            ...
            <p>Quicksell uses reliable third-party couriers for domestic deliveries within South Africa. The courier handling your order is shown in your order details once a shipment is created.</p>
            ...
            <p className="text-sm text-gray-600">These are estimated delivery times and are not guaranteed; actual times vary by courier. Delays may occur due to circumstances beyond Quicksell's control, including public holidays, adverse weather, or courier operational issues.</p>
            ...
            <p>Quicksell is not liable for delays, losses, or damage caused by the shipping provider. However, Buyers who experience delivery issues should contact Quicksell support at <a href="mailto:info@quicksellsa.co.za" className="text-primary-600 hover:underline">info@quicksellsa.co.za</a> for assistance.</p>

            <p className="font-semibold text-gray-800 mt-4 mb-3">7.7 Delivery Address</p>
            <p>Buyers are responsible for providing a correct and complete delivery address at checkout. Quicksell is not responsible for items delivered to an incorrect address provided by the Buyer.</p>
          </section>
          ...
          <section>
            ...
            <p>8.3.2 Refunds are made to the Buyer's Quicksell Wallet or using the original payment method, at Quicksell's discretion.</p>
          </section>
          ...
          <section>
            ...
            <p>9.4 Quicksell reserves the right to cancel orders in cases of suspected fraud, pricing errors, or policy violations.</p>
          </section>
          ...
          <section>
            ...
            <p>11.3 Sellers may request withdrawal of available funds from their Wallet. Withdrawal requests are reviewed by Quicksell and processed within a reasonable time.</p>
            <p>11.4 Quicksell reserves the right to withhold Seller funds in cases of disputes, chargebacks, or suspected fraud.</p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-2">
              ...
              <li>Use automated bidding tools without written authorisation from Quicksell</li>
          ...
          <section>
            ...
            <p>13.1 All Platform content, branding, logos, and software belong to Quicksell or its licensors.</p>
            <p>13.2 Users grant Quicksell a non-exclusive, royalty-free licence to display listing content (including images and descriptions) for Platform purposes.</p>
          </section>
          ...
          <section>
            ...
            <p>To operate the Platform, Quicksell collects the following categories of personal data:</p>
            <ul className="list-disc pl-6 space-y-1 mt-2">
            ...
            <p>Quicksell uses personal data only for the following specified, lawful purposes:</p>
            <ul className="list-disc pl-6 space-y-2 mt-2">
              ...
              <li><strong>Identity verification (KYC):</strong> reviewing submitted identity documents and selfies to confirm a User's identity. This protects all Users from fraud, impersonation, and unauthorised account use. KYC submissions are reviewed manually by Quicksell administrators and the data is retained only for as long as required to maintain a verified status or to comply with applicable law.</li>
            ...
            <p>To deliver the services described in Section 14.3, Quicksell shares limited personal data with the following categories of third-party operators, each of which is contractually bound to process the data only on Quicksell's behalf and in accordance with POPIA:</p>
            <ul className="list-disc pl-6 space-y-1 mt-2">
              ...
              <li><strong>Email and notification providers:</strong> Resend - to deliver transactional emails on Quicksell's behalf</li>
            ...
            <p className="mt-2">Quicksell does not sell personal data to advertisers or other unrelated third parties.</p>

            <p className="font-semibold text-gray-800 mt-4 mb-3">14.5 Security Measures</p>
            <p>Quicksell applies reasonable, industry-standard technical and organisational safeguards to protect personal data, including:</p>
            <ul className="list-disc pl-6 space-y-1 mt-2">
              <li>Passwords are stored using one-way hashing - they cannot be read or recovered, even by Quicksell staff</li>
              <li>Sensitive data is transmitted over encrypted HTTPS connections</li>
              <li>Card details are never stored on Quicksell servers; they are handled directly by our payment gateway partners</li>
            ...
            <ul className="list-disc pl-6 space-y-1 mt-2">
              <li>Request access to the personal data Quicksell holds about you</li>
          ...
          <section>
            ...
            <p className="mt-2">15.3 Quicksell's total liability in connection with any claim shall not exceed the amount paid by the User for the specific transaction giving rise to the claim.</p>
          </section>

          {/* 16. INDEMNITY */}
          <section>
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">16. Indemnity</h2>
            <p>Users indemnify Quicksell, its directors, employees, and agents against any claims, losses, or damages arising from:</p>
            <ul className="list-disc pl-6 space-y-1 mt-2">
          ...
          <section>
            ...
            <p>17.1 Quicksell may suspend or terminate accounts without prior notice for breaches of these Terms, fraudulent activity, or any conduct that Quicksell deems harmful to the Platform or its Users.</p>
            <p>17.2 Outstanding obligations (including pending payments and deliveries) survive termination.</p>
            <p>17.3 Users may request account deletion by contacting <a href="mailto:info@quicksellsa.co.za" className="text-primary-600 hover:underline">info@quicksellsa.co.za</a>. Pending transactions must be completed or resolved before deletion.</p>
          </section>
          ...
          <section>
            ...
            <p>19.2 Quicksell may offer internal dispute resolution mechanisms, including mediation between Buyer and Seller.</p>
          ...
          <section>
            ...
            <p>20.1 Quicksell may amend these Terms from time to time. Updated Terms will be posted on the Platform with a revised "Last Updated" date.</p>
            <p>20.2 Continued use of the Platform after an amendment constitutes acceptance of the updated Terms.</p>
            <p>20.3 Where material changes are made, Quicksell will endeavour to notify Users via email or in-app notification.</p>
          </section>

          {/* 21. AFFILIATE / REFERRAL PROGRAM */}
          <section>
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">21. Affiliate / Referral Program</h2>
            <p>Quicksell operates an optional affiliate (referral) programme that allows eligible Users to earn commission by referring new Users to the Platform.</p>
            ...
            <p>Quicksell may amend, suspend, or discontinue the affiliate programme, or change the commission rate, at any time. Material changes will be reflected in these Terms with a revised "Last Updated" date.</p>
          </section>

          {/* 22. BUYER PROTECTION POLICY */}
          <section>
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">22. Buyer Protection Policy</h2>
            <p>At Quicksell, we are committed to providing a safe and secure online shopping experience. Our Buyer Protection Programme helps protect customers when items purchased through the Platform are not delivered, arrive damaged, or are significantly different from the product description. If a problem occurs with your order, Quicksell will, to the best of its ability, work to resolve the matter fairly and efficiently. This Section complements (and does not replace) your rights under Sections 8 (Returns and Refunds) and 19 (Dispute Resolution).</p>
            ...
            <p className="mt-3"><strong>(a) Item Not Received</strong> - you may be eligible for a refund if the logistics partner fails to ship the item, the parcel is lost in transit, tracking confirms non-delivery, or the item is delivered to the wrong address due to a Quicksell error.</p>
            ...
            <ul className="list-disc pl-6 space-y-1 mt-2">
              <li>Depending on the circumstances, Quicksell may provide a prepaid return label or reimburse reasonable return shipping costs.</li>
              <li>Approved refunds are made to the original payment method or to the buyer's Quicksell Wallet, and are normally processed within <strong>5-14 business days</strong> after approval.</li>
            </ul>

            <p className="font-semibold text-gray-800 mt-4 mb-3">22.5 Dispute Resolution Process</p>
            <ol className="list-decimal pl-6 space-y-2 mt-2">
              <li><strong>Contact Quicksell:</strong> first attempt to resolve the matter directly via the Quicksell messaging/support system.</li>
              <li><strong>Open a Dispute:</strong> if a resolution cannot be reached, open a dispute through your Quicksell account, including the order number, a description of the problem, supporting evidence, and your desired resolution.</li>
              <li><strong>Quicksell Mediation:</strong> Quicksell may review product listings, shipping and tracking records, communications, and the evidence submitted by both parties, and will then issue a decision based on the available evidence.</li>
            </ol>

            <p className="font-semibold text-gray-800 mt-4 mb-3">22.6 Quicksell Responsibilities and Limits</p>
            <p>Quicksell will, to the best of its ability, ensure products are accurately described, orders are shipped within the stated timeframe, reliable courier services are used, valid tracking is provided, and dispute investigations are supported. Quicksell reserves the right to reject claims where fraudulent information is provided, evidence has been altered or fabricated, multiple abusive claims are identified, or the buyer has violated these Terms. Quicksell may investigate suspected fraud and cooperate with law-enforcement authorities where required.</p>
          </section>
          ...
          <section>
            ...
            <div className="bg-gray-50 rounded-lg p-5">
              <p className="font-semibold text-gray-900 mb-3">Quicksell (Pty) Ltd</p>
              <p>Email: <a href="mailto:info@quicksellsa.co.za" className="text-primary-600 hover:underline">info@quicksellsa.co.za</a></p>
              <p>Website: <a href="https://www.quicksell.co.za" className="text-primary-600 hover:underline">www.quicksell.co.za</a></p>
